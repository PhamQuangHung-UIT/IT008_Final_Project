...
namespace MainForm
{
    public partial class FAddHD : Form
    {
        ...
        void loaddataDV()
        {
            ...
            command.CommandText = "select tenDV,giatien,soluong from DichVu, HDDV where DichVu.iddv=HDDV.iddv";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            command = connection.CreateCommand();
            command.CommandText = "insert into KHACHHANG values ('" + tbMaKH.Text + "','" + tbTenKH.Text + "','" + tbSDT.Text + "','" + tbDC.Text + "')";
            ...
            foreach(Table item in listtable)
            {
                ...
                {
                    if (ct.Text == "Bàn " + item.Idban + Environment.NewLine + "trống" )
                    {
            ...
            command = connection.CreateCommand();
            command.CommandText = "insert into HoaDon(idhd,MAKH) values ('" + FMain.idhd + "','" + tbMaKH.Text + "')";
            command.ExecuteNonQuery();
